...
router.get('/electiva/:todos' , async (req,res) => {
    if (req.params.todos == 'true'){
        res.json(await estudiantes.estudiantesElectiva(true))
    } else {
        res.json(await estudiantes.estudiantesElectiva(false))
    }
})
